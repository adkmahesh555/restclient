...
var baseurl = "https://wsa.pfconcept.com/test/v01/restclient/";
...
$(document).ready(function(){
	...
	$("#additemcode").on("keypress", function(e){ 
		if(e.which === 13) $("#addItemSearchbtn").trigger("click");
	});
...
function f_searchitem(){
	...
	$.get(url,function(data,status){
		...
		if (status == "success") {
			...
			$("#colpriceinfo,#stockinfo,#decoinfo").collapse("show");
