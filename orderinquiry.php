  ...
  <div class="container" style="margin-top:60px;">
	 <div class="panel panel-primary">
		<div class="panel-heading">
			<b>Order Overview</b>
			<button type="button" class="btn btn-xs btn-warning font-bold pull-right" data-toggle="modal" data-target="#orderOvSearchModal">Search</button>
		</div>
		<div class="panel-body bg-alice">
			<div id="orderoverview-content" class="table-responsive" style="border: 1px solid lightseagreen;border-radius:4px;">
				...
				<div class="pager orderovpager">
					<button type="button" class="btn btn-default round15 prev disabled" data-from="" data-find="prev" onclick="f_prevnextorder(this)">Previous</button>
					<button type="button" class="btn btn-default round15 next" data-from="11" data-find="next" data-totalrows="<?php echo $totalrows ?>" onclick="f_prevnextorder(this)">&nbsp;Next&nbsp; </button>
				</div>			
			</div>
