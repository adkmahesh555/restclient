        ...
        <div class="container-fluid"  style="margin-top:60px;">
            <div class="row">
										...
										<div class="row">
											<div class="col-sm-7">
												<div class="input-group">
													<input type="text" id="additemcode" maxlength="8" class="form-control" value="10000205">
                            ...
                            <div id="decoOptions-wrapper" class="collapse">
                                <div class="panel-body bg-alice">                                    
                                    <div>
										...
										<div id="decoOptions-content" style="max-height:450px;overflow-y:auto;border:2px solid lightblue;">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="text-right">	                        
                        <button type="button" id="btn-setOrder" class="btn btn-success hidden" onclick="f_setOrder()" style="margin:7px;">Confirm Order </button><br>
                    </div>
